...
SELECT country_code FROM cities WHERE country_code IN ('NLB', 'ALB', 'DZA');
...
SELECT name, indep_year population FROM countries WHERE indep_year < '1990' OR population > 100000;

-- 問13
-- コードがDZAもしくはALBかつ独立記念日が1990年より前の国を全て抽出してください。
SELECT code, name FROM countries WHERE indep_year < '1999' AND code IN ('DZA', 'ALB');
...
SELECT 1991 as birth_year, COUNT(*) as count
FROM celebrities
WHERE birth::text LIKE '%1991%'
UNION
SELECT 1981 as birth_year, COUNT(*) as count
FROM celebrities
